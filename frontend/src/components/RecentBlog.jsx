...
const RecentBlog = () => {
    ...
    useEffect(() => {
        const getAllPublsihedBlogs = async () => {
            try {
                const res = await axios.get(`https://webeliteblogenzo.onrender.com/api/v1/blog/get-published-blogs`, { withCredentials: true })
                if (res.data.success) {
        ...
        <div className='bg-gray-100 dark:bg-gray-800 pb-10'>
            ...
            <div className='max-w-7xl mx-auto flex gap-6'>
                ...
                <div className='bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10'>
                    ...
                    <p className='text-sm text-gray-600 dark:text-gray-400'>Ricevi gli ultimi post e gli aggiornamenti direttamente nella tua casella di posta.</p>
